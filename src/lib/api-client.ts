...
export namespace coupons {
    ...
    hasMore: boolean
        ...
        /**
         * List available coupons for a campaign (shopper discovery before enrollment)
         * Allows shoppers to see bonus coupons before deciding to enroll
         */
...
export namespace enrollments {
    ...
    export class ServiceClient {
         ...
         */
        public async deleteDeliverable(enrollmentId: string, deliverableId: string): Promise<{
    success: boolean
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("DELETE", `/enrollments/${encodeURIComponent(enrollmentId)}/deliverables/${encodeURIComponent(deliverableId)}`)
            return await resp.json() as {
    success: boolean
}
        }
        ...
        /**
         * Get enrollment by ID (Shopper-only)
         * Brands should use GET /organizations/:organizationId/enrollments/:id
         * For shoppers: includes deliverables array for easy submission
         */
         ...
         * Shopper-only: Brands should use GET /organizations/:organizationId/enrollments/:id
         */
    ...
    screenshotUrl: string
        ...
        /**
         * POST /enrollments/:id/deliverables
         * Submit deliverables for enrollment
         */
        public async submitDeliverables(id: string, params: SubmitDeliverablesRequest): Promise<Enrollment> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/enrollments/${encodeURIComponent(id)}/deliverables`, JSON.stringify(params))
            return await resp.json() as Enrollment
        }
         ...
         */
        public async updateDeliverable(enrollmentId: string, deliverableId: string, params: {
    proofLink?: string
    proofScreenshot?: string
}): Promise<EnrollmentDeliverable> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PATCH", `/enrollments/${encodeURIComponent(enrollmentId)}/deliverables/${encodeURIComponent(deliverableId)}`, JSON.stringify(params))
...
export namespace organizations {
    ...
    export interface WalletTransaction {
        ...
        type: "credit" | "debit"
        /**
         * Transaction status: pending (inflight hold) or completed (applied)
         */
