/**
 * UPI Icon - Based on official UPI logo
 */

import type { SVGProps } from "react";

export function UpiIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
