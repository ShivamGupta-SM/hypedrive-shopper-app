...
function BalanceCard({
  ...
  return (
    <div className="overflow-hidden rounded-xl bg-emerald-600 dark:bg-emerald-700">
  ...
  return (
    <div className="flex items-center gap-3 border-b border-zinc-100 px-4 py-3.5 last:border-0 dark:border-zinc-800">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-0.5 truncate text-xs text-zinc-500 dark:text-zinc-400">
          {withdrawal.withdrawalMethod?.bankName || "Bank Account"} ••••{withdrawal.withdrawalMethod?.accountNumberLast4 || "****"}
        </p>
      </div>
      <div className="shrink-0 text-right">
...
function WithdrawDialog({
  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      await client.wallet.createWithdrawal({
                ...
                >
                  {verifiedMethods.map((method) => (
                    <option key={method.id} value={method.id}>
                      {method.bankName || "Bank Account"} ••••{method.accountNumberLast4 || "****"}
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <StatCard
          ...
          label="Withdrawn"
          value={`₹${wallet?.totalWithdrawnDecimal || stats?.withdrawnAmountDecimal || "0"}`}
          variant="info"
        />
      </div>
        ...
        <div className="overflow-hidden rounded-xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
          ...
          {txLoading ? (
            ...
            <div>
              ...
              {txList.length === 0 && stats && stats.approved > 0 && (
                <TransactionRow
                  type="credit"
        ...
        <div className="overflow-hidden rounded-xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
          ...
          {withdrawalsLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
                Withdraw your earnings when you're ready
              </p>
            </div>
          ) : (
            <div>
