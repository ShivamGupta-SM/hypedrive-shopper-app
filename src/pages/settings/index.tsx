...
function ProfileHeader({
  ...
  return (
    <button
      type="button"
      onClick={onEdit}
      className="flex w-full items-center gap-4 rounded-2xl bg-white p-4 text-left shadow-sm ring-1 ring-zinc-950/5 active:bg-zinc-50 dark:bg-zinc-900 dark:ring-white/10 dark:active:bg-zinc-800"
    >
      {/* Avatar */}
...
function KYCStatusRow({
  ...
  return (
    ...
    >
      ...
      {verified ? (
        <span className="text-[13px] text-emerald-600 dark:text-emerald-400">Verified</span>
      ) : (
        <button
          type="button"
          onClick={onVerify}
          className="rounded-full bg-zinc-100 px-3 py-1 text-[13px] font-medium text-zinc-900 active:bg-zinc-200 dark:bg-zinc-800 dark:text-white dark:active:bg-zinc-700"
        >
          Verify
        </button>
      )}
...
export function Settings() {
  ...
  const handleKYCVerify = (type: "pan" | "aadhaar") => {
  ...
  return (
    <div className="mx-auto max-w-lg space-y-7 pb-8">
      {/* Profile Header */}
      <ProfileHeader
        profile={{ userName, userEmail, initials }}
      ...
      <section>
        ...
        <MenuSection>
          ...
          {hasAddress && (
            <>
              <MenuSeparator />
              <div className="rounded-b-xl bg-white px-4 py-3 dark:bg-zinc-900">
        ...
        <SectionFooter>
          Your address is used for verification and delivery purposes.
        </SectionFooter>
      </section>
      ...
      <section>
        ...
        <MenuSection>
          <KYCStatusRow
            verified={kycStatus?.panVerified || false}
            label="PAN Card"
            onVerify={() => handleKYCVerify("pan")}
            isFirst
          />
          <MenuSeparator />
          <KYCStatusRow
            verified={kycStatus?.aadhaarVerified || false}
            label="Aadhaar Card"
            onVerify={() => handleKYCVerify("aadhaar")}
            isLast
          />
        </MenuSection>
        <SectionFooter>
          Complete KYC to enable withdrawals over ₹30,000/year. TDS will be deducted at applicable rates.
        </SectionFooter>
      </section>
          ...
          {methodsLoading ? (
            ...
            <>
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-b-xl bg-white py-3 text-[15px] font-medium text-sky-600 active:bg-zinc-50 dark:bg-zinc-900 dark:text-sky-400 dark:active:bg-zinc-800"
              >
            ...
            <button
              type="button"
              onClick={() => setIsAddingBank(true)}
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-white py-4 text-[15px] font-medium text-sky-600 active:bg-zinc-50 dark:bg-zinc-900 dark:text-sky-400 dark:active:bg-zinc-800"
            >
              <PlusIcon className="size-4" />
              Add Payment Method
            </button>
      ...
      {/* Footer */}
      <p className="pt-4 text-center text-[13px] text-zinc-400">
